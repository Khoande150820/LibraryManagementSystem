...
public class Main {
    ...
    static final String filename = "book.txt";
...
//                            System.out.println(Arrays.toString(arrOfString));
                ...
                case 113:
                    ...
                    Node searchNode = blist.search("3");
                    searchNode.info.setPrice(8);
                    blist.traverse();
                    break;
                case 114:
                    Node DeletedNode = blist.search("2");
                    blist.remove(DeletedNode);
                    blist.traverse();
                    break;
